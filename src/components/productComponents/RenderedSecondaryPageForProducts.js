...
const RenderedPage = ({ layoutSpecs, layoutHeightProp, layoutWidthProp, background, recurentBackground }) => {
    ...
    const layoutStyle = {
        ...
        width: `${(layoutHeightProp ? layoutHeightProp : layoutWidth) - 2 * layoutPadding - 15}px`,
    ...
    return (
        <div style={{ display: "inline-block", width: "49%", zIndex: "9999" }}>
                    ...
                    <Grid container
                        ...
                        {(secondLayoutRow1 >= 1) &&
                            <Grid item xs={secondLayoutRow1Col1} style={column}>
                                <div style={innerColumn} width={`${((layoutWidth - 2 * layoutPadding) / secondLayoutRow1) - 2 * secondLayoutBorderWidth}px`}>
